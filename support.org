...
#+begin_src emacs-lisp
  ...
  (let ((config (concat episteme/home "/config.el")))
    (when (file-exists-p config)
      (message "Loading config from: %s" config)
      (load-file config)))
...
#+begin_src emacs-lisp
  (use-package dashboard
    ...
    (setq dashboard-startup-banner "/home/ldlework/src/apoptosis/episteme/cain.png")
