...
#+begin_src emacs-lisp
  (defun :hydra/add-exit-head (heads)
    (let ((exit-head '("SPC" (hera-pop) "to exit" :color teal)))
...
#+begin_src emacs-lisp
  ...
  (:hydra episteme-hydra-help (:color teal)
    ("Describe"
...
#+begin_src emacs-lisp
  ...
  (:hydra episteme-hydra-window (:color amaranth)
    ("Jump"
...
** hydra-zoom
#+begin_src emacs-lisp
  (:hydra episteme-hydra-zoom (:color amaranth)
    ("Buffer"
     ...
     (("I" zoom-frm-in "in")
      ("O" zoom-frm-out "out")
      ("r" toggle-zoom-frame "reset" :color teal))))
#+end_src

** hydra-dev
#+begin_src emacs-lisp
  (:hydra episteme-hydra-dev (:color teal)
    ("Open"
...
#+begin_src emacs-lisp
  ...
  (:hydra episteme-hydra-default (:color teal)
    ("Open"
...
#+begin_src emacs-lisp
  ...
  (:hydra episteme-hydra-text (:color amaranth :major-mode text-mode)
    ("Move"
...
** hydra-elisp
#+begin_src emacs-lisp
  (:hydra episteme-hydra-elisp (:color teal :major-mode emacs-lisp-mode)
    ("Execute"
     (("d" eval-defun "defun")
     ...
     (("D" edebug-defun "defun")
      ("a" edebug-all-defs "all definitions" :color amaranth)
      ("A" edebug-all-forms "all forms" :color amaranth)
 ...
 #+begin_src emacs-lisp
   (:hydra episteme-hydra-org (:color amaranth :major-mode org-mode)
     ("Shift"
      ...
      "Perform"
      (
       ("t" (org-babel-tangle) "tangle" :color teal)
       ("e" (org-html-export-to-html) "export" :color teal)
