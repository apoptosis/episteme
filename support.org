...
** internal
*** episteme--remote-confirm-dirty-removal
#+begin_src emacs-lisp
  (defun episteme--remote-confirm-dirty-removal (name)
    (let ((msg (concat "Remote %s has uncommited changes!" " "
                       "Are you sure you want to remove it?")))
      (yes-or-no-p (format msg name))))
...
*** remote-is-safe-to-remove-p
#+begin_src emacs-lisp
  (defun episteme-remote-is-safe-to-remove-p (name)
    (not (or (episteme-remote-is-local-p name) (episteme-remote-is-dirty-p name))))
#+end_src
*** get-remote-path
#+begin_src emacs-lisp
      ...
      (if (f-exists? path)
          ...
          (if (episteme-remote-is-default-p name)
            ...
            (when (yes-or-no-p (format "Are you sure you want to remove %s?" name))
              ...
              (when (or (episteme-remote-is-safe-to-remove-p name)
                        (episteme--remote-confirm-dirty-removal name))
